...
module.exports = {
	validator: (req, errAvatar, taskCurrent) =>{		
		...
		//SPECIAL
		req.checkBody('special', 'Chọn một trạng thái').not().isIn(option.special),
		//Category
		req.checkBody('category_id', 'Chọn một trạng thái').not().isIn(option.group),
		//CONTENT
